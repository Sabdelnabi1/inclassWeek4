...
//here is the shorter version without a return statement
const add100 = function (money) {
    return money + 100;
};

const arrowAddOneHundred = (money) => money + 100;

console.log(arrowAddOneHundred(100))
...
//first I created a function that takes a string and a letter. Then I had it find how many times a specfic letter comes up in there and subtract by one because now it is an array
let letterCount = (string, find) => (string.split(find)).length - 1;

//then I console logged it to count how many times P comes up in the string
console.log(letterCount("Peter Pan Picks Pickles", "P"));